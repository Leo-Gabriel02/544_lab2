...
from utilities import Logger, euler_from_quaternion, TurtleBot
import rclpy
...
from controller import kai, kap, kav, kli, klp, klv, TYPE, MOTION
...
class localization(Node):
    ...
    def __init__(self, localizationType=rawSensor):
        ...
        self.loc_logger=Logger(f"CSVs/robot_pose-{data}.csv", ["x", "y", "theta", "stamp"])
        self.pose=None
